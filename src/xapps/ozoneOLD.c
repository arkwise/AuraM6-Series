...
we need to add the settings for the theme in reg to make ozone work
...
l_ulong AppVersion = ULONG_ID(0,0,1,2);
...
l_int Main ( int argc, l_text *argv )
{
	...
	*/
	...
	ThemeLoad(KeyGetText("/USER/DESKTOP/ozone", "/DESKTOP/plex.ini"));

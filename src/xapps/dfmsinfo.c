...
#include "fms2.h"
/*
001 attempt to fix menu.h issues
*/
...
void MakeCodecItems(PTreeItem i, PCodec c)
{
	...
	si = AddTreeItem(i, "Files extensions", NULL, NULL, NULL);
	if (FExts->Last)
	{
...
l_int Main(int argc, l_text *argv)
{
	...
	AddMenuItemEx(Menu, "Edit", NULL, 0, 0, NULL, NULL, NULL);
	AddMenuItemEx(Menu, "View", NULL, 0, 0, NULL, NULL, NULL);

...
* 
*       
*       the aim of aura m6 is to complete the TCP app transition and finialise the multithreading code + the sdk so peopoe can finally develop their own apps based on 
...
_PUBLIC char* KernelCopyright   = "doscore 2007-2023";
_PUBLIC int   KernelVersion             = 4000;
_PUBLIC char* KernelTextVersion = "Milestone 6";
